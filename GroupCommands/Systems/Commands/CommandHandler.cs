...
{
    public class CommandHandler : IRuntimeSystem
    {
        ...
        public void Run(string argument, UpdateType updateSource)
        {
            ...
            try
            {
                command.Execute(_program, _commandLine);
            }
            catch (Exception e)
            {
        ...
        private void PrintUsage()
        {
            ...
            sb.AppendLine("--- Group Commands Script ---");
            sb.AppendLine(
                "Use this script to send commands to groups of a same bloc without affecting groups with the same name from other grids\n");
